    ...
    var t = {
        ...
        headerSearchToggle: function() {
            e(".search-toggle").on("click", function(t) {
                e(".header-search-wrapper").toggleClass("show"), e("body").toggleClass("is-search-active"), t.preventDefault()
        ...
        filterSlider: function() {
            ...
            null != t && (noUiSlider.create(t, {
                ...
                e("#filter-price-range-input").val(t.join(","))
            }))
        },
