...
<head>
    ...
    <script src="https://kit.fontawesome.com/90720d5eb1.js" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/notifIt.min.css') }}">
    @yield('css')
    <title>@php echo $_SERVER['HTTP_HOST']; @endphp vendor</title>
</head>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" target="_blank" href="{{URL::to('/')}}">@php echo $_SERVER['HTTP_HOST']; @endphp</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('vendor.index') }}"><i class="fa fa-fw fa-rocket"></i>Dashboard</a>
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-orders" class="collapse submenu @if(Request::url() ==  route('vendor.orders') or Request::url() ==  route('admin.payments')) show @endif" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('vendor.orders') }}"><i class="fas fa-shopping-cart"></i>Orders</a>
                                            
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('vendor.wallet') }}"><i class="fas fa-dollar-sign"></i>Payments</a>
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu @if(Request::url() ==  route('admin.product.create') or Request::url() ==  route('admin.products') or Request::url() ==  route('admin.reviews') or Request::url() ==  route('admin.city.create') or Request::url() ==  route('admin.cities') or Request::url() ==  route('admin.shipping.edit', 1)) show @endif" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('vendor.product.create')}}">Add New</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             All rights reserved. @php echo $_SERVER['HTTP_HOST']; @endphp</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
