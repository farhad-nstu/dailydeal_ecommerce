        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.product.update', $product->id) }}" method="post" enctype="multipart/form-data" id="form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <img src="{{ asset('images/'.$image->image) }}" width="100"><a href="{{route('admin.product.image.delete',$image->id)}}"><i class="fas fa-times-circle" style="
                    margin-left: 7px;
                    position: absolute;
                    "></i></a>
                    </div>
                    ...
                    @foreach($all_keys as $key)
                        ...
                        <div class="field_wrapper_update">
                            <div class="form-group col-md-8" style="padding-left: 0">
                                ...
                                <label style="font-size: 13px;">Price (Format: 1kg - 500tk)</label><br>
