    ...
    @else
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                ...
                <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">Wishlists</div>
                                      ...
                                      <div class="col-md-12 pb-5">
                                        ...
                                        @foreach($wishlists as $wishlist)
                                          <div class="cart-item d-md-flex justify-content-between">
                                            ...
                                            <span class="remove-item"> <a href="{{route('wishlist.delete', $wishlist->id)}}"> <i class="fa fa-times"></i> </a></span>
                                            

                                              <div class="px-3 my-3">
                                                  <a class="cart-item-product" href="{{route('product.show', $wishlist->product->slug)}}">
                                                      <div class="cart-item-product-thumb"><img src="{{asset('images/'.$wishlist->product->images->first()->image)}}" alt="Product"></div>
                                                      <div class="cart-item-product-info">
                                                          <h4 class="cart-item-product-title">{{$wishlist->product->title}}</h4>
                                                          <div class="text-lg text-body font-weight-medium pb-1">Tk. {{$wishlist->product->price}}</div><span>Availability: <span class="text-success font-weight-medium">
                                                          @if($wishlist->product->title == 0)
